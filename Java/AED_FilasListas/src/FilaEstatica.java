public class FilaEstatica {
    ...
    /**
     * Busca um aluno pelo critério da classe Aluno
     * @param quem Objeto mock a ser procurado
     * @return Aluno encontrado ou null, se não existir
     */
    Aluno pesquisar(Aluno quem){
        for(int i=0; i<quantidade; i++){
            if(quem.ehIgual(dados[i])) return dados[i];
        }
        return null;
    }
    /**
     * Retorna os dados dos elementos da fila em string
     * @return String com dados de alunos da Fila
     */
    String dadosFila(){
